DROP TABLE IF EXISTS `nyc_project.raw_green_trips`;

CREATE TABLE IF NOT EXISTS `nyc_project.raw_green_trips`
(
    ...
    yearmonth INT64 OPTIONS (description = 'Year month number of the source filename from which the trip data was loaded.'),      
